...
cmd({
  ...
  try {
    ...
    if (!mimeType || !mimeType.startsWith("image")) {
      return reply("_*❌ PLEASE REPLY TO AN IMAGE.*_");
    }

    reply("_*🔄 UPLOADING IMAGE...*_");
    ...
    if (!data || !data.data || !data.data.url) {
      throw "_*❌ FAILED TO UPLOAD THE IMAGE.*_";
    }
    ...
    const msgContext = {
      ...
      forwardedNewsletterMessageInfo: {
        newsletterJid: "1203633543106228@newsletter",
        newsletterName: "RAZA",
        serverMessageId: 143
      }
    };
